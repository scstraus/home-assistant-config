...
SPEAKER_ENTITIES= ["media_player.living_room_airtunes_speaker", "media_player.kitchen_airtunes_speaker", "media_player.bathroom_1st_floor_airtunes_speaker",
"media_player.apple_tv_airtunes_speaker",
"media_player.master_bath_airtunes_speaker",
"media_player.office_airtunes_speaker", "media_player.library_airtunes_speaker", "media_player.computer_airtunes_speaker", "media_player.sophie_s_room_airtunes_speaker", "media_player.sebastian_s_room_airtunes_speaker", "media_player.gym_airtunes_speaker"]
#      - media_player.master_bedroom_airtunes_speaker

for count in range(len(SPEAKER_ENTITIES)):
  logger.debug("Working on item %s",count)
  time.sleep(2)
