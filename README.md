...
- [Automations](#automations)
  ...
  * [Location Automations](#-location-automations)
    ...
    + [Tell me when to take the ferry across the river if I'm biking to work](#tell-me-when-to-take-the-ferry-across-the-river-if-i-m-biking-to-work)
  * [Security Automations](#-security-automations)
    ...
    + [Turn off the PIR outdoor security lights if it's too windy](#turn-off-the-pir-outdoor-security-lights-if-it-s-too-windy)
    + [Get notified if someone else turns the alarm on while you aren't home](#get-notified-if-someone-else-turns-the-alarm-on-while-you-aren-t-home)
