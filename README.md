...
* 10 Zone [Apple Airtunes](https://www.home-assistant.io/integrations/itunes/) whole house audio deployment based on forked-daapd with a self built script + app daemon bridge to Alexa for pretty comprehensive voice control and also playlist buttons and lists in the UI which outputs to individual amps with in-wall/cieling speakers in each room.
