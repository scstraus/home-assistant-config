...
* 10 Zone Apple Airplay based whole house audio deployment based on [forked-daapd](https://www.home-assistant.io/integrations/forked_daapd/_) with a [self built app daemon bridge to Alexa](https://github.com/scstraus/home-assistant-config/blob/master/appdaemon/apps/playlist_in_room.py) for pretty comprehensive voice control and also playlist buttons and lists in the UI which outputs to Apple Airports and [Pi zeros](https://www.raspberrypi.com/products/raspberry-pi-zero/)'s running [shairport sync](https://github.com/mikebrady/shairport-sync) with [DAC hats](https://shop.justboom.co/products/justboom-dac-zero-phat), and individual amps with in-wall/cieling speakers in each room, all in perfect sync between rooms. I've even experimented with using room assistant on the Pis to have the audio automatically follow me around the house, but will need to replace a lot of the airports with Pis before that will really be viable.
* The [tensorflow](https://www.tensorflow.org/) based human detection using [frigate](https://github.com/blakeblackshear/frigate) and a [Google coral USB stick](https://coral.ai/products/accelerator/) on my [hikvision cameras](https://www.hikvision.com/content/dam/hikvision/en/support/regional-materials/brazil/DS-2CD2620F-I(S)%20%20-%20customized%20for%20Cangacu%20City%20-%20Bidding%2004-2015.pdf), which notifies me of various types of human detections around the house
